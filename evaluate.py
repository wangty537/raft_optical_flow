...
if __name__ == '__main__':
    ...
    parser.add_argument('--model',default='/home/redpine/share11/code/RAFT-master/checkpoints/raft-sintel.pth', type=str, help="restore checkpoint")
    ...
    with torch.no_grad():
        if args.dataset == 'chairs':
            ...
            validate_sintel(model.module, iters=8) 
